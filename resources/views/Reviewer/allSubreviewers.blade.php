        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">Subreviewers</h1>
                
                    <!-- DataTales Example -->
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">Subreviewers</h6>
                        </div>
                        <div class="card-body">
                            <div class="table-responsive">
                            @if($reviewconfiguration->allowSubreviews!="NO")
                                <a class="btn btn-primary" href="{{ route ('createSubReviewer', $trackId) }}">Add Sub-Reviewer</a>
                            @endif
                                ...
                                <thead>
                                  ...
                                  <td>{{$user->user->web}}</td> 
                                  <?php $hashids = new Hashids\Hashids('',40); $userId=$hashids->encode($user->user->id); ?>
              
                                  <td><a class="btn btn-primary" href="{{ route('showingassignedPaper', $userId) }}">Assign</a></td>
                                  </tr>
