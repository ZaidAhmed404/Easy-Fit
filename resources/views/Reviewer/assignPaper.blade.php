                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-body">
                            ...
                            <form action="{{ route ('assigningPaper.subreviewer' ,$UserId) }}" method="post">
                                    @csrf
                            <center>
                                    ...
                                    <div class="form-check">
                                      <tr>
                                        <td>
                                        <input type="radio" value="{{$paper->paper->id}}" name="paper" id="paper" required>
                                        </td>
                                          <td>
