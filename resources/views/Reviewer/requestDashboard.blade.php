            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <center><a  href="{{ route('rejectOffer', $roleId) }}" title="Reject"><button type="button" class="btn btn-danger">Reject</button></a>
                        <a  href="{{ route('acceptOffer' , $roleId) }}" title="Accept"><button type="button" class="btn btn-info">Accept</button></a></center>
