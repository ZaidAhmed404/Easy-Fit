              ...
              <li class="nav-item">
                ...
                <div id="collapse3" class="collapse show" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item active" href="{{URL::to('addingSuperchair', $id)}}">Add new Superchair</a>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">{{$Conference->acronym}} Add new Superchair</h1>
                ...
                <!-- /.container-fluid -->
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <form action="{{ route ('superchair.assigning', $conferenceId) }}" method="post">
                          @csrf
