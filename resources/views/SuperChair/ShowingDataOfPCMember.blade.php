              ...
              <li class="nav-item">
                ...
                <div id="collapse2" class="collapse show" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item active" href="{{ route ('addingPCMemberWithoutInivitationPage' , $id) }}">Add new PC members</a>
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <form action="{{ route ('addingPCMemberWithoutInvitation', $TrackId) }}" method="post">
                            @csrf
