              ...
              <li class="nav-item">
                ...
                <div id="collapse3" class="collapse show" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item active" href="{{ route ('conferenceTracks.show' , $id) }}">Tracks</a>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">{{$Conference->acronym}} Add Trackchair</h1>
                    <!-- DataTales Example -->
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">Trackchair Data</h6>
    
                        </div>
                        <div class="card-body">
                          
                        <?php $hashids = new Hashids\Hashids('',40); $id=$hashids->encode($Track->id); ?>
                        <form action="{{ route ('trackchair.assign', $id) }}" method="post">
                          @csrf
                  <div class="form-group row">
                      <label for="staticEmail" class="col-sm-2 col-form-label">First Name</label>
                      <div class="col-sm-8">
                      <input placeholder="First Name" class="form-control"  value="{{$user->firstName}}" type="text" id="firstName" name="firstName" readonly>
                          </div>
                    </div>
                  ...
                  <div class="form-group row">
                      ...
                      <div class="col-sm-8">
                      <input placeholder="Last Name" class="form-control"  id="lastName" name="lastName" value="{{$user->lastName}}" type="text" readonly>
                          </div>
                    </div>
                  <div class="form-group row">
                  ...
                  <div class="form-group row">
                      ...
                      <div class="col-sm-8">
                      <input placeholder="Organization" value="{{$user->organization}}" class="form-control"  id="organization" name="organization"  type="text" readonly>
                          </div>
                    </div>
                  <div class="form-group row">
                      ...
                      <input placeholder="Web" class="form-control" value="{{$user->web}}" id="web" name="web"  type="text" readonly>
                          </div>
                    </div>
