...
<body id="page-top">
            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse show" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item active" href="{{ route ('createMultipleSubreviewers', $id) }}">Pool of Subreviewers</a>
  ...
  <li class="nav-item">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">Subreviewers Information</h1>
                ...
                <!-- /.container-fluid -->
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">Subreviewer Form</h6>
                        </div>
                        <div class="card-body">
                        <?php $hashids = new Hashids\Hashids('',40); $conferenceId=$hashids->encode($Conference->id); ?>
                                    
                        <form action="{{ route('createMultipleSubreviewers.create' ,['id'=>$conferenceId]) }}" method="post">
                            @csrf
                    <center>
                    ...
                    <table class="table table-bordered" id="dynamicTable">  
                                ...
                                <tr>  
                                    <td>
                                        <input type="text" name="data[0][email]" placeholder="Enter your Easyfit Email" class="form-control" required/>
                            
                                <label for="tracks">Choose a Track</label>
                    <select class="form-select" aria-label="Default select example" name="data[0][tracks]" id="data[0][tracks]">
    ...
    $("#add").click(function(){
        ++i;
        $("#dynamicTable").append('<tr><td><input type="text" name="data['+i+'][email]" placeholder="Enter your EasyFit Email" class="form-control" required/><label for="tracks">Choose a Track</label><select class="form-select" aria-label="Default select example" name="data['+i+'][tracks]" id="data['+i+'][tracks]">@foreach ($tracks as $track)<option value="{{$track->id}}">{{$track->Name}}</option>{{$track->Name}}@endforeach</select><br></td><td><button type="button" class="btn btn-danger remove-tr">Remove</button></td></tr>');
    });
