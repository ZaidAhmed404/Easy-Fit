              ...
              <li class="nav-item">
                ...
                <div id="collapse2" class="collapse show" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item active" href="{{ route ('invitingPCMember' , $id) }}">Invitiation to PC</a>
              ...
              <li class="nav-item">
                ...
                <div id="collapse3" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                      ...
                      <a class="collapse-item" href="{{URL::to('conferenceTrackchairs', $id)}}">All Trackchairs</a>
                      </div>
                </div>
            </li>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">{{$Conference->acronym}} Displaying PC Member Data</h1>
                ...
                <!-- /.container-fluid -->
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">PC Member Data</h6>
                        </div>
                        <div class="card-body">
                        <?php $hashids = new Hashids\Hashids('',40); $TrackId=$hashids->encode($Track->id); ?>
                          
                        <form action="{{ route ('sendingRequestToReviewer' ,$TrackId) }}" method="post">
                        @csrf
                <div class="form-group row">
                    <label for="staticEmail" class="col-sm-2 col-form-label">First Name</label>
                    <div class="col-sm-8">
                    <input value="{{$user->firstName}}" placeholder="First Name"  class="form-control"   type="text" id="firstName" name="firstName" readonly>
                        </div>
                </div>
                <div class="form-group row">
                    <label for="staticEmail" class="col-sm-2 col-form-label">Last Name</label>
                    <div class="col-sm-8">
                    <input placeholder="Last Name" value="{{$user->lastName}}" class="form-control"  id="lastName" name="lastName"  type="text" readonly>
                        </div>
                </div>
                <div class="form-group row">
                    <label for="staticEmail" class="col-sm-2 col-form-label">Email</label>
                    <div class="col-sm-8">
                    <input placeholder="Email" class="form-control" value="{{$user->email}}" id="email" name="email"  type="text" readonly>
                        </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                    <input placeholder="Country/Region" class="form-control" value="{{$user->country}}"  id="country" name="country"  type="text" readonly>
                        </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                    <input placeholder="Organization" class="form-control" value="{{$user->organization}}" id="organization" name="organization"  type="text" readonly>
                        </div>
                </div>
                <div class="form-group row">
                    ...
                    <input placeholder="Web" class="form-control"  id="web" value="{{$user->web}}" name="web"  type="text" readonly>
                        </div>
                </div>
