        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">{{$Conference->acronym}} Add New Track Form</h1>
                    Please fill out the form below. Some items on the form are explained here:
                      <ul>
                          <li>
                          <strong>Track Name</strong> is the entry for adding track name which would be dislayed by all Authors,Reviewers and TrackChair.
                          </li>
                          <li>
                          <strong>Short name</strong> is just a short representation of Track name.
                          </li>
                    </li>
                  <br>
                    <!-- DataTales Example -->
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">Track Form</h6>
                        </div>
                        <div class="card-body">
                        <?php $hashids = new Hashids\Hashids('',40); $conferenceId=$hashids->encode($Conference->id); ?>
                                    
                        <form action="{{ route ('track.add', $conferenceId) }}"  method="post">
                          @csrf
                  <div class="form-group row">
                      <label for="staticEmail" class="col-sm-2 col-form-label">Track Name<sup class="star">*</sup></label>
                      <div class="col-sm-8">
                      <input placeholder="Enter the Track Name" class="form-control"   type="text" id="name" name="name" required>
                          </div>
                    </div>
                          <div class="form-group row">
                      <label for="staticEmail" class="col-sm-2 col-form-label">Short Name<sup class="star">*</sup></label>
                      <div class="col-sm-8">
                      
                      <input placeholder="Enter the Short Name" class="form-control"   type="text" id="shortName" name="shortName" required>
                          </div>
                    </div>
                          <center>
