        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">{{$Paper->conference->conferenceName}}</h1>
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{$Paper->conference->web}}">{{$Paper->conference->web}}</a>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                    ...
                                    <td>
                                    <?php $hashids = new Hashids\Hashids('',40); $conferenceId=$hashids->encode($Paper->conference->id); ?>
