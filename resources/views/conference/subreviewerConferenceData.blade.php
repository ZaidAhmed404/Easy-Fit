...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="nav-link" href="{{ route ('subReviewerDashboardBoard' , $trackId) }}">
            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item " href="{{ route ('showingAllSubmissions', $trackId) }}">All Submissions</a>
                        <a class="collapse-item" href="{{ route ('checkreviewsPage.Subreviewer' , $trackId) }}">All Reviews</a>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">{{$track->conference->conferenceName}}</h1>
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        {{$track->conference->conferenceName}}
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{$track->conference->web}}">{{$track->conference->web}}</a>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                    ...
                                    <td>
                                    <?php $hashids = new Hashids\Hashids('',40); $conferenceId=$hashids->encode($track->conference->id); ?>
