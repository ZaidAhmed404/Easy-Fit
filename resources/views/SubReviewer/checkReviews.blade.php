        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">List of All Reviews</h1>
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                ...
                                <thead>
                                  ...
                                  <a class="btn btn-primary" href="{{ route('editreviewPage.Subreviewer' , $reviewId) }}">Edit</a>
                                  <a class="btn btn-danger" href="{{ route('deletereview.Reviewer' , $reviewId) }}">Delete</a>
