    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse show" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item active" href="{{ route ('showingAllSubmissions', $trackId) }}">All Submissions</a>
            ...
            <?php $hashids = new Hashids\Hashids('',40); $trackId=$hashids->encode($track->id); ?>
                ...
                <a class="nav-link" href="{{ route ('subreviewerConferenceData' , $trackId) }}">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">List of Submissions</h1>
                            ...
                            <div class="table-responsive">
                                ...
                                <thead>
                                  ...
                                  <tr> 
                                    ...
                                    <td>@foreach($paper->paper->authors as $author)
                                        {{$author->user->firstName}} {{$author->user->lastName}} ;
                                        @endforeach</td>
                                  <td>{{$paper->paper->Title}}</td>
                                  <td>
                                  <?php $hashids = new Hashids\Hashids('',40); $paperId=$hashids->encode($paper->paper->id); ?>
            
                                  <a class="btn btn-primary" href="{{ route('subreviewerAssigniedPaper' , $paperId) }}">Details</a>
                                  @if($reviewconfiguration->allowReviews!="NO")
                                  <a class="btn btn-primary" href="{{ route('subreviewerreviewingPaperPage', $paperId) }}">Review</a>
                                  @endif
                                  </td>
                                  </tr>
