        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">Reviewing Paper</h1>
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-body">
                        <?php $hashids = new Hashids\Hashids('',40); $PaperId=$hashids->encode($paperId); ?>
            
                        <form  action="{{ route('subreviewerreview' , $PaperId) }}" method="post">
                            @csrf
            ...
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                <textarea placeholder="Enter the Review for Reviewers"  class="form-control"   type="text" id="reviewForReviewers" name="reviewForReviewers" rows="10" cols="200" required></textarea>
                  <br>
                    <center>
