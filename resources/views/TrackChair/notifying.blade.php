  ...
  <li class="nav-item">
    ...
    <div id="collapse2" class="collapse show" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
        <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item active" href="{{ route ('notifyingReviewerPage' , $trackId) }}">Send Email</a>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">Notifying All PC members</h1>
                    <!-- DataTales Example -->
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-body">
                        <form  action="{{ route('notifyingReviewers' ,['id'=>$trackId]) }}" method="post">
                            @csrf
                            <div class="form-group row">
                        <label for="staticEmail" class="col-sm-2 col-form-label">Subject</label>
                        <div class="col-sm-8">
                        <input placeholder="Enter the Subject" class="form-control"   type="text" id="subject" name="subject" required>
                            </div>
                      </div>
                    ...
                    <div class="form-group row">    
                        ...
                        <div class="col-sm-8">
                        <label for="email"><strong>NOTE</strong>:Respected Name will automatically add so ONLY type you message.</label>
                            <br><br>
                        
                        <textarea placeholder="Enter the Body"  class="form-control"   type="text" id="body" name="body" rows="10" cols="200" required></textarea>
                            </div>
                      </div>
                    <br>
                          <br>
