  ...
  <li class="nav-item">
    ...
    <div id="collapse2" class="collapse show" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
        <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="{{ route ('addingReviewer' , $trackId) }}">Invitiation to PC</a>
           
            <a class="collapse-item active" href="{{ route ('addingReviewerWithoutInvitiationPage' , $trackId) }}">Add new PC members</a>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">Displaying Reviewer Data</h1>
                    
                    <!-- DataTales Example -->
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">Reviewer Data</h6>
                        </div>
                        <div class="card-body">
                        <form action="{{ route ('addReviewer' ,$trackId) }}" method="post">
                            @csrf
