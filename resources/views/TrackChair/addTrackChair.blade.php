            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    Please fill out the form below. Some items on the form are explained here:
                        <ul>
                            <li>
                            <strong>Email address</strong> will only be used for communication with the Reviewers and SuperChair.
                            </li>
                            <li>
                            <strong>Note: Email MUST be registered</strong> 
                                  </li>
                        </ul>             
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">Trackchair Form</h6>
                        ...
                        <form action="{{ route ('showingTrackchairData', $id) }}" method="post">
                          @csrf
