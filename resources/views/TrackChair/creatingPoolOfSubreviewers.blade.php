...
<li class="nav-item">
    ...
    <div id="collapseTwo" class="collapse show" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
        <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item active" href="{{ route ('creatingPoolOfSubreviewersPage', $trackId) }}">Pool of Subreviewers</a>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">Subreviewer Form</h1>
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">Enter Subreviewer Data</h6>
                        </div>
                        <div class="card-body">
                        <?php $hashids = new Hashids\Hashids('',40); $trackId=$hashids->encode($Track->id); ?>

                        <form action="{{ route('creatingPoolOfSubreviewers' ,['id'=>$trackId]) }}" method="post">
                              @csrf
...
<script type="text/javascript">
      ...
      $("#add").click(function(){
          ++i;
          $("#dynamicTable").append('<tr><td><input type="text" name="data['+i+'][email]" placeholder="Enter your EasyFit Email" class="form-control" required/></td><td><button type="button" class="btn btn-danger remove-tr">Remove</button></td></tr>');
      });
