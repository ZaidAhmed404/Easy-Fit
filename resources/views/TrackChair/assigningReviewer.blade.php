  ...
  @if($conferenceReviewerConfiguration->allowTrackchairStatusMenu=="YES")
    ...
    <div id="collapse1" class="collapse show" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
        <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item active" href="{{ route ('allpapers' , $trackId) }}">By Submission</a>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">Selecting PC Members</h1>
                    <!-- DataTales Example -->
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-body">
                            ...
                            <form action="{{ route ('ReviewerAssigning' ,$PaperId) }}" method="post">
                              @csrf
                              ...
                              <div class="form-check">
                                <tr>
                                  <td>
                                  <input type="checkbox" value="{{$user->user->id}}" name="user[]" id="user">
