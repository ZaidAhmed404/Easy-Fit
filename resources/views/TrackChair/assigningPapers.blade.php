        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">Selecting Papers</h1>
                    <!-- DataTales Example -->
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-body">
                            ...
                            <?php $hashids = new Hashids\Hashids('',40); $UserId=$hashids->encode($userId); ?>
 
                            <form action="{{ route ('assigning' ,$UserId) }}" method="post">
                            @csrf
                            ...
                            <div class="form-check">
                              <tr>
                                <td>
                                <input  type="checkbox" value="{{$paper->id}}" name="paper[]" id="paper">
                                </td>
                                  <td>
