                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-body">
                            ...
                            <form action="{{ route ('editUserData') }}" method="post">
                                    @csrf
                            <div class="form-group row">
                                <label for="staticEmail" class="col-sm-2 col-form-label">First Name</label>
                                <div class="col-sm-6">
                                <input value="{{$user->firstName}}" placeholder="First Name"  class="form-control"   type="text" id="firstName" name="firstName">
                                    </div>
                              </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-6">
                                <input placeholder="Last Name" value="{{$user->lastName}}" class="form-control"  id="lastName" name="lastName"  type="text">
                                    </div>
                              </div>
                            <div class="form-group row">
                                <label for="staticEmail" class="col-sm-2 col-form-label">Email</label>
                                <div class="col-sm-6">
                                <input placeholder="Email" class="form-control" value="{{$user->email}}" id="email" name="email"  type="text">
                                    </div>
                              </div>
                              <div class="form-group row">
                                  <label for="country" class="col-sm-2 col-form-label">{{ __('Country') }}<sup class="star">*</sup></label>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-6">
                                <input placeholder="Organization" class="form-control" value="{{$user->organization}}" id="organization" name="organization"  type="text">
                                    </div>
                              </div>
                            <div class="form-group row">
                                ...
                                <input placeholder="Web" class="form-control"  id="web" value="{{$user->web}}" name="web"  type="text">
                                    </div>
                              </div>
