...
<head>
    ...
    <title>Showing Author Data</title>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">Displaying Author Data</h1>
                               <ul>
                                        <li>
                                        <strong>Email address</strong> will only be used for communication with the authors. It will not appear in public Web pages of this conference.
                                        </li>
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-body">
                            <?php $hashids = new Hashids\Hashids('',40); $conferenceId=$hashids->encode($Paper->conference->id); $trackId=$hashids->encode($Paper->track->id); ?>
                                        ...
                                        <form action="{{ route ('Author.storeData',['paperId' => $paperId,'conferenceId' => $conferenceId,'trackId'=>$trackId]) }}" method="post">
                                        @csrf
                                <div class="form-group row">
                                    <label for="staticEmail" class="col-sm-2 col-form-label">First Name</label>
                                    <div class="col-sm-8">
                                    <input placeholder="First Name" value="{{$user->firstName}}" class="form-control"   type="text" id="firstName" name="firstName" readonly>
                                        </div>
                                </div>
                                        <div class="form-group row">
                                    <label for="staticEmail" class="col-sm-2 col-form-label">Last Name</label>
                                    <div class="col-sm-8">
                                    <input placeholder="Last Name" class="form-control" value="{{$user->lastName}}" id="lastName" name="lastName"  type="text" readonly>
                                        </div>
                                </div>
                                 <div class="form-group row">
                                    <label for="staticEmail" class="col-sm-2 col-form-label">Email</label>
                                    <div class="col-sm-8">
                                    <input placeholder="Email" class="form-control"  id="email" name="email" value="{{$user->email}}" type="text" readonly>
                                        </div>
                                </div>
                                
                                        <div class="form-group row">
                                    <label for="staticEmail" class="col-sm-2 col-form-label">Country/Region</label>
                                    <div class="col-sm-8">
                                    <input placeholder="Country/Region" class="form-control"  id="country" name="country" value="{{$user->country}}" type="text" readonly>
                                        </div>
                                </div>
                                    ...
                                    <div class="col-sm-8">
                                    <input placeholder="Organization" class="form-control"  id="organization" value="{{$user->organization}}" name="organization"  type="text" readonly>
                                        </div>
                                </div>
                                    ...
                                    <input placeholder="Web" class="form-control"  id="web" name="web" value="{{$user->web}}" type="text" readonly>
                                        </div>
                                </div>
                                        
                                    
                                        <div class="form-group row">
                                    <label for="staticEmail" class="col-sm-2 col-form-label">Correcponding Author</label>
                                    <div class="col-sm-8">
                                    
                                    <input placeholder="Web" class="form-control"  id="correcpondingAuthor" name="correcpondingAuthor" value="{{$correcpondingAuthor}}" type="text" readonly>
                                        </div>
                                </div>
