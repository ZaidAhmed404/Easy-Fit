            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse show" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item active" href="{{URL::to('Paper/edit', $paperId)}}">Edit</a>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">Editing Paper Form</h1>
                
                    <!-- DataTales Example -->
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">Paper Form</h6>
                        </div>
                        <div class="card-body">
                            
                        <form action="{{ route ('Paper.update', $paperId) }}"  enctype="multipart/form-data" method="post">
                          @csrf
                  ...
                  <div class="form-group row">
                      ...
                      <div class="col-sm-10">
                      <input value="{{$Paper->Title}}" placeholder="Title" class="form-control"   type="text" id="title" name="title" required>
                          </div>
                    </div>
                          ...
                          <div class="form-group row">
                      <label for="staticEmail" class="col-sm-2 col-form-label">Abstract</label>
                      <div class="col-sm-10">
                      <textarea  placeholder="Abstract"  class="form-control"   type="text" id="abstract" name="abstract" rows="10" cols="100" required>{{$Paper->Abstract}}</textarea>
                          </div>
                    </div>
                          
                    <p> Note: <strong>All Keywords will be Overrided. IF none keywords are added, then there will be no keywords for Your Paper.</strong> </p>
                    
                    <p>After Enter any keyword;Press Enter key on Keyboard.</p> <br><br>
                    <div class="form-group row">
