...
class CreateSubReviewersTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('sub_reviewers', function (Blueprint $table) {
            $table->id();
            ...
            $table->foreign('RequestedBy')->references('id')->on('users')->onDelete('cascade')->onUpdate('cascade');
    ...
    {
        Schema::dropIfExists('sub_reviewers');
    }
}
